...
public class BST<E extends Comparable<E>> extends AbstractTree<E> {
	 ...
	 * is not in the tree.
	 */
	//Endret også denne fra private til package sånn jeg kan teste den i junit
	...
	//Endret denne til package slik at jeg kan teste den med junit
	...
	public ArrayList<E> getPath(E e) {
		...
		while (node != null && search(node.element)) {
	...
	public boolean delete(E e) {
		...
		if (current.left == null) {
			...
			rightMost.parent = parentOfRightMost.parent;
